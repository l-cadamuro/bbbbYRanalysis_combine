...
fIn_proto = '../cards/higgsCombineBDTG_6_masscut_finalsel_SR_syst{}.Significance.mH120.root'

systs = ['0.0000000001', '0.1', '0.25', '0.5', '1.0', '2.0', '5.0', '10.0']
sels = [(s, float(s)) for s in systs]
...
gr.Draw('APL')
gr.GetXaxis().SetLimits(0.01,50.)
gr.GetXaxis().SetTitle("Uncertainty on high S/B bins [%]")
if plot_loss:
